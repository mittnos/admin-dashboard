    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[200px] p-0">
        <Command>
          ...
          <CommandList>
            <CommandGroup>
              {/* Buscar porque este boton esta en disabled?  */}
              <CommandItem
                onSelect={() => {
                  setOpen(false);
                  storeModal.onOpen();
                }}
                className="cursor-pointer hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                data-disabled={true}
                >
